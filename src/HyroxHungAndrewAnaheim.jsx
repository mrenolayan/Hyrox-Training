...
const weekPlan = [
  ...
  {
    week: 1, phase: 1, focus: "Ease in. HIIT Mon · Strength Tue · Easy Run Wed · Stations Thu · Long Run Sat.",
    days: [
      ...
      { day: "Wed", a0: { type: "run_easy", label: "Easy Run 4km", detail: "Easy, 9:00–9:30/mi. Zone 2, conversational. Note how your legs feel.", metric: "Avg pace /mi or /km" }, a1: { type: "run_easy", label: "Easy Run 4km", detail: "Treadmill or outdoor, 9:30–10:00/mi. Zone 2. No pushing yet — just baseline.", metric: "Avg pace /mi or /km" } },
      { day: "Thu", a0: { type: "stations", label: "Station Intro — Machines", detail: "Gym. Ski erg 3×250m easy · Row 3×250m easy · Farmers carry 3×40m light. Focus on form, not speed.", metric: "Time / splits" }, a1: { type: "stations", label: "Station Intro — Ground Work", detail: "Home. Sled push 4×12.5m moderate · Wall ball 3×15 (6kg) · Sandbag lunges 3×20m. Learn the movements.", metric: "Time / splits" } },
  ...
  {
    week: 2, phase: 1, focus: "Shift the order. Easy Run Mon · Stations Tue · Strength Wed · HIIT Thu · Long Run Sat.",
    days: [
  ...
  {
    week: 3, phase: 1, focus: "Strength B intro. Strength Mon · Easy Run Tue · HIIT Wed · Sled/Stations Thu · Long Run Sat.",
    days: [
  ...
  {
    week: 4, phase: 1, focus: "Circuits + first pace run. Stations Mon · HIIT Tue · Easy Run Wed · Strength Thu · Pace Run Sat.",
    days: [
      ...
      { day: "Tue", a0: { type: "conditioning", label: "HIIT", detail: "4 Rounds For Time: 300m run · 12 burpees · 15 air squats · 10 walking lunges. Log time.", metric: "Total time" }, a1: { type: "conditioning", label: "HIIT", detail: "4 Rounds For Time: 300m run · 12 burpees · 15 air squats · 10 walking lunges. Log time.", metric: "Total time" } },
      ...
      { day: "Thu", a0: { type: "strength", label: "Strength A", detail: "Gym. Back squat 4×6 · RDL 3×8 · Walking lunges 3×20/leg · Kettlebell carry 3×100m · Calf raises 3×15. Beat last week's weights.", metric: "Top weight" }, a1: { type: "strength", label: "Strength A", detail: "Home gym. Back squat 4×6 · RDL 3×8 · Cable rows 3×12 · Box jumps 4×8 · Calf raises 3×15. Beat last week.", metric: "Top weight" } },
      { day: "Fri", a0: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null }, a1: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null } },
  ...
  {
    week: 6, phase: 2, focus: "Build begins. Easy Run Mon · Brick Tue · HIIT Wed · Strength Thu · Long Run Sat.",
    days: [
      ...
      { day: "Thu", a0: { type: "strength", label: "Strength A", detail: "Gym. Back squat 4×6 · RDL 3×8 · Walking lunges 3×20/leg · Kettlebell carry 3×100m · Calf raises 3×15.", metric: "Top weight" }, a1: { type: "strength", label: "Strength A", detail: "Home/gym. Back squat 4×6 · RDL 3×8 · Cable rows 3×12 · Box jumps 4×8 · Sandbag cleans 3×8 · Calf raises 3×15.", metric: "Top weight" } },
      { day: "Fri", a0: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null }, a1: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null } },
  ...
  {
    week: 7, phase: 2, focus: "Sled benchmark. Strength Mon · Easy Run Tue · Brick Wed · HIIT Thu · Long Run Sat.",
    days: [
      { day: "Mon", a0: { type: "strength", label: "Strength B", detail: "Gym. Deadlift 4×5 · Bent-over row 3×8 · Sandbag lunges 3×20m · Burpee broad jumps 3×8. Increase loads.", metric: "Top weight" }, a1: { type: "strength", label: "Strength B", detail: "Home/gym. Bench press 4×6 · Cable fly 3×10 · Sandbag lunges 4×20m · Wall ball 3×20 · Box jumps 3×10.", metric: "Top weight" } },
      { day: "Tue", a0: { type: "run_easy", label: "Easy Run 5km", detail: "Easy, 9:00–9:30/mi. Zone 2. Fresh legs after strength yesterday.", metric: "Avg pace /mi or /km" }, a1: { type: "run_easy", label: "Easy Run 5km", detail: "Treadmill or outdoor, 9:30–10:00/mi. Zone 2. Relaxed effort.", metric: "Avg pace /mi or /km" } },
  ...
  {
    week: 8, phase: 2, focus: "Brick intensity up. HIIT Mon · Strength Tue · Easy Run Wed · Brick Thu · Long Run Sat.",
    days: [
      ...
      { day: "Wed", a0: { type: "run_easy", label: "Easy Run 5km", detail: "Easy, 9:00–9:30/mi. Zone 2 — a needed breather between hard sessions.", metric: "Avg pace /mi or /km" }, a1: { type: "run_easy", label: "Easy Run 5km", detail: "Treadmill or outdoor, 9:30–10:00/mi. Zone 2 opener.", metric: "Avg pace /mi or /km" } },
      { day: "Thu", a0: { type: "brick", label: "BRICK — Row + Run", detail: "Gym. 4×(row 250m + 800m run at 8:30/mi). Row is your strength — note splits.", metric: "Round times" }, a1: { type: "brick", label: "BRICK — Sled Pull + Run", detail: "Gym visit. 4×(sled pull 12.5m + 400m treadmill/run at 9:00/mi). Sled pull is a major weak spot — attack it today.", metric: "Round times" } },
      { day: "Fri", a0: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null }, a1: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null } },
  ...
  {
    week: 10, phase: 2, focus: "Peak build. Brick Mon · HIIT Tue · Easy Run Wed · Strength Thu · Long Run Sat.",
    days: [
  ...
  {
    week: 11, phase: 2, focus: "Race-intensity bricks. Easy Run Mon · Strength Tue · HIIT Wed · Brick Thu · Long Run Sat.",
    days: [
      ...
      { day: "Wed", a0: { type: "conditioning", label: "HIIT", detail: "AMRAP 20:00: 400m run · 15 burpees · 20 walking lunges · 12 jumping squats. Log rounds.", metric: "Rounds" }, a1: { type: "conditioning", label: "HIIT", detail: "AMRAP 20:00: 400m run · 15 burpees · 20 walking lunges · 12 jumping squats. Log rounds.", metric: "Rounds" } },
      { day: "Thu", a0: { type: "brick", label: "BRICK — Ski + Farmers + Run", detail: "Gym. 4×(ski 250m + farmers carry 40m (2×24kg) + 800m at 8:30/mi). Your strength stations — own them. Log all splits.", metric: "Round times" }, a1: { type: "brick", label: "BRICK — Farmers + BBJ + Run", detail: "Gym visit. 4×(farmers carry 40m + 10 box jumps + 400m run at 8:30/mi). Attack your weak stations.", metric: "Round times" } },
      { day: "Fri", a0: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null }, a1: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null } },
  ...
  {
    week: 12, phase: 2, focus: "Peak week. HIIT Mon · Easy Run / Pace Test Tue · Stations Wed · Strength Thu · Long Run Sat.",
    days: [
      { day: "Mon", a0: { type: "conditioning", label: "HIIT", detail: "AMRAP 20:00: 400m run · 20 burpees · 20 walking lunges · 15 air squats. Log rounds.", metric: "Rounds" }, a1: { type: "conditioning", label: "HIIT", detail: "AMRAP 20:00: 400m run · 20 burpees · 20 walking lunges · 15 air squats. Log rounds.", metric: "Rounds" } },
      ...
      { day: "Thu", a0: { type: "strength", label: "Strength B (peak)", detail: "Gym. Deadlift 4×5 · Bent-over row 4×8 · Sandbag lunges 4×20m · Burpee broad jumps 4×10. Heaviest of the plan.", metric: "Top weight" }, a1: { type: "strength", label: "Strength B (peak)", detail: "Home/gym. Bench press 4×6 · Sandbag lunges 4×20m · Wall ball 4×25 · Box jumps 4×12.", metric: "Top weight" } },
      { day: "Fri", a0: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null }, a1: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null } },
  ...
  {
    week: 14, phase: 3, focus: "Sharpen. Easy Run Mon · Brick Tue · HIIT Wed · Strength Thu · Long Run Sat.",
    days: [
      ...
      { day: "Thu", a0: { type: "strength", label: "Strength (light)", detail: "Gym. 70% loads. Back squat 3×5 · RDL 3×6. Nothing heavy — protect the body.", metric: "Top weight" }, a1: { type: "strength", label: "Strength (light)", detail: "Home. 70% loads. Back squat 3×5 · Cable rows 3×8. Light and sharp.", metric: "Top weight" } },
      { day: "Fri", a0: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null }, a1: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null } },
