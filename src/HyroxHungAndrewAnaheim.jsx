...
// a0 = Hung · a1 = Andrew. Day structure rotates week to week — nothing locks to the same day.
// Both: easy run Mon–Thu (varies) + long run Sat. 2 runs/week. HIIT synced same day each week it appears.
// Deload weeks (5, 9): 4 days only — station sharpener replaces long run.
...
const weekPlan = [
  ...
  {
    week: 1, phase: 1, focus: "Ease in. HIIT Mon · Strength Tue · Rest Wed · Easy Run Thu · Stations Fri · Long Run Sat.",
    days: [
      { day: "Mon", a0: { type: "conditioning", label: "HIIT", detail: "AMRAP 12:00: 200m run · 10 air squats · 8 burpees. Log your rounds.", metric: "Rounds" }, a1: { type: "conditioning", label: "HIIT", detail: "AMRAP 12:00: 200m run · 10 air squats · 8 burpees. Log your rounds.", metric: "Rounds" } },
      { day: "Tue", a0: { type: "strength", label: "Strength A", detail: "Gym. Back squat 4×6 · RDL 3×8 · Walking lunges 3×20/leg · Kettlebell carry 3×100m · Calf raises 3×15.", metric: "Top weight" }, a1: { type: "strength", label: "Strength A", detail: "Home gym. Back squat 4×6 · RDL 3×8 · Cable rows 3×10 · Box jumps 3×8 · Calf raises 3×15.", metric: "Top weight" } },
      ...
      { day: "Thu", a0: { type: "run_easy", label: "Easy Run 4km", detail: "Easy, 9:00–9:30/mi. Zone 2, conversational. Note how your legs feel.", metric: "Avg pace /mi or /km" }, a1: { type: "run_easy", label: "Easy Run 4km", detail: "Treadmill or outdoor, 9:30–10:00/mi. Zone 2. No pushing yet — just baseline.", metric: "Avg pace /mi or /km" } },
      { day: "Fri", a0: { type: "stations", label: "Station Intro — Machines", detail: "Gym. Ski erg 3×250m easy · Row 3×250m easy · Farmers carry 3×40m light. Focus on form, not speed.", metric: "Time / splits" }, a1: { type: "stations", label: "Station Intro — Ground Work", detail: "Home. Sled push 4×12.5m moderate · Wall ball 3×15 (6kg) · Sandbag lunges 3×20m. Learn the movements.", metric: "Time / splits" } },
      { day: "Sat", a0: { type: "run_long", label: "Long Run 5km", detail: "Easy effort, 9:00–9:30/mi. Log your pace.", metric: "Avg pace /mi or /km" }, a1: { type: "run_long", label: "Long Run 5km", detail: "Treadmill or outdoor, 9:30–10:00/mi. Log your pace.", metric: "Avg pace /mi or /km" } },
  ...
  {
    week: 2, phase: 1, focus: "Volume up. Easy Run Mon · Stations Tue · Strength Wed · Rest Thu · HIIT Fri · Long Run Sat.",
    days: [
      { day: "Mon", a0: { type: "run_easy", label: "Easy Run 4km", detail: "Easy, 9:00–9:30/mi. Zone 2. Building from last week.", metric: "Avg pace /mi or /km" }, a1: { type: "run_easy", label: "Easy Run 4km", detail: "Treadmill or outdoor, 9:30–10:00/mi. Steady Zone 2.", metric: "Avg pace /mi or /km" } },
      { day: "Tue", a0: { type: "stations", label: "Machines — Volume", detail: "Gym. Ski erg 4×250m (note splits) · Row 4×250m · Farmers carry 4×40m. Rest 90s between sets.", metric: "Time / splits" }, a1: { type: "stations", label: "Ground Work — Volume", detail: "Home. Sled push 4×12.5m · Wall ball 4×15 (6kg) · Sandbag lunges 4×20m.", metric: "Time / splits" } },
      { day: "Wed", a0: { type: "strength", label: "Strength A", detail: "Gym. Back squat 4×6 · RDL 3×8 · Walking lunges 3×20/leg · Kettlebell carry 3×100m · Calf raises 3×15.", metric: "Top weight" }, a1: { type: "strength", label: "Strength A", detail: "Home gym. Back squat 4×6 · RDL 3×8 · Cable rows 3×10 · Box jumps 3×8 · Calf raises 3×15. Add 5lb from last week.", metric: "Top weight" } },
      ...
      { day: "Fri", a0: { type: "conditioning", label: "HIIT", detail: "3 Rounds For Time: 400m run · 15 air squats · 10 jumping lunges · 10 burpees. Rest 90s. Log total time.", metric: "Total time" }, a1: { type: "conditioning", label: "HIIT", detail: "3 Rounds For Time: 400m run · 15 air squats · 10 jumping lunges · 10 burpees. Rest 90s. Log total time.", metric: "Total time" } },
      { day: "Sat", a0: { type: "run_long", label: "Long Run 6km", detail: "Easy, 9:00–9:30/mi. Log pace.", metric: "Avg pace /mi or /km" }, a1: { type: "run_long", label: "Long Run 6km", detail: "Treadmill or outdoor, 9:30–10:00/mi. Log pace.", metric: "Avg pace /mi or /km" } },
      { day: "Sun", a0: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null }, a1: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null } },
    ],
  },
  {
    week: 3, phase: 1, focus: "Strength B intro. Strength Mon · Easy Run Tue · HIIT Wed · Sled/Stations Thu · Rest Fri · Long Run Sat.",
    days: [
      { day: "Mon", a0: { type: "strength", label: "Strength B", detail: "Gym. Deadlift 4×5 · Bent-over row 3×8 · Sandbag lunges 3×20m · Burpee broad jumps 3×8.", metric: "Top weight" }, a1: { type: "strength", label: "Strength B", detail: "Home/gym. Bench press 4×6 · Cable chest fly 3×10 · Cable lateral raises 3×12 · Wall ball 3×15 · Box jumps 3×8.", metric: "Top weight" } },
      { day: "Tue", a0: { type: "run_easy", label: "Easy Run 5km", detail: "Easy, 9:00–9:30/mi. Zone 2, keep it comfortable.", metric: "Avg pace /mi or /km" }, a1: { type: "run_easy", label: "Easy Run 5km", detail: "Treadmill or outdoor, 9:30–10:00/mi. Zone 2.", metric: "Avg pace /mi or /km" } },
      { day: "Wed", a0: { type: "conditioning", label: "HIIT", detail: "AMRAP 15:00: 200m run · 12 walking lunges · 10 air squats · 8 burpees. Log rounds.", metric: "Rounds" }, a1: { type: "conditioning", label: "HIIT", detail: "AMRAP 15:00: 200m run · 12 walking lunges · 10 air squats · 8 burpees. Log rounds.", metric: "Rounds" } },
      { day: "Thu", a0: { type: "stations", label: "Sled + Machine Circuit", detail: "Gym. 3 Rounds: sled push 12.5m heavy + ski 250m + row 250m + farmers carry 40m. Rest 2 min. Sled is your weak spot — attack it.", metric: "Round times" }, a1: { type: "sled", label: "Sled Benchmark", detail: "Home. 4×(sled push 12.5m + sled pull 12.5m). Full rest. Log weight and time for every set.", metric: "Weight / time" } },
      ...
      { day: "Sat", a0: { type: "run_long", label: "Long Run 7km", detail: "Easy, 9:00–9:30/mi. Log pace.", metric: "Avg pace /mi or /km" }, a1: { type: "run_long", label: "Long Run 7km", detail: "Treadmill or outdoor, 9:30–10:00/mi. Log pace.", metric: "Avg pace /mi or /km" } },
      { day: "Sun", a0: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null }, a1: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null } },
    ],
  },
  {
    week: 4, phase: 1, focus: "Circuits + first pace run. Stations Mon · Rest Tue · Easy Run Wed · HIIT Thu · Strength Fri · Pace Run Sat.",
    days: [
      { day: "Mon", a0: { type: "stations", label: "Full Circuit", detail: "Gym. For time: ski 500m · row 500m · farmers carry 40m · sled push 12.5m. Rest 3 min. Repeat 2 more rounds.", metric: "Round times" }, a1: { type: "stations", label: "Full Circuit", detail: "Home. For time: sled push 12.5m · sled pull 12.5m · wall ball 20 reps · sandbag lunges 20m · box jumps 10. Rest 3 min. Repeat 2 more rounds.", metric: "Round times" } },
      ...
      { day: "Wed", a0: { type: "run_easy", label: "Easy Run 5km", detail: "Easy, 9:00–9:30/mi. Zone 2. Legs are open now — keep it conversational.", metric: "Avg pace /mi or /km" }, a1: { type: "run_easy", label: "Easy Run 5km", detail: "Treadmill or outdoor, 9:30–10:00/mi. Steady Zone 2.", metric: "Avg pace /mi or /km" } },
      { day: "Thu", a0: { type: "conditioning", label: "HIIT", detail: "4 Rounds For Time: 300m run · 12 burpees · 15 air squats · 10 walking lunges. Log time.", metric: "Total time" }, a1: { type: "conditioning", label: "HIIT", detail: "4 Rounds For Time: 300m run · 12 burpees · 15 air squats · 10 walking lunges. Log time.", metric: "Total time" } },
      { day: "Fri", a0: { type: "strength", label: "Strength A", detail: "Gym. Back squat 4×6 · RDL 3×8 · Walking lunges 3×20/leg · Kettlebell carry 3×100m · Calf raises 3×15. Beat last week's weights.", metric: "Top weight" }, a1: { type: "strength", label: "Strength A", detail: "Home gym. Back squat 4×6 · RDL 3×8 · Cable rows 3×12 · Box jumps 4×8 · Calf raises 3×15. Beat last week.", metric: "Top weight" } },
      { day: "Sat", a0: { type: "run_pace", label: "Pace Run 8km", detail: "Push to 8:30–9:00/mi. First real effort run — not a sprint, but not easy. Log pace.", metric: "Avg pace /mi or /km" }, a1: { type: "run_pace", label: "Pace Run 8km", detail: "Push to 9:00–9:30/mi. First real push — step it up from your easy pace. Log pace.", metric: "Avg pace /mi or /km" } },
      { day: "Sun", a0: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null }, a1: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null } },
    ],
  },
  {
    ...
    days: [
      { day: "Mon", a0: { type: "run_easy", label: "Easy Run 3km (light)", detail: "Very easy, 10:00/mi or slower. Deload — just move.", metric: "Avg pace /mi or /km" }, a1: { type: "run_easy", label: "Easy Run 3km (light)", detail: "Very easy, 10:00–10:30/mi. Deload — no pushing.", metric: "Avg pace /mi or /km" } },
      ...
      { day: "Wed", a0: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null }, a1: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null } },
      { day: "Thu", a0: { type: "conditioning", label: "HIIT (light)", detail: "AMRAP 10:00 (easy): 200m jog · 8 air squats · 6 burpees. Gentle effort. Log rounds.", metric: "Rounds" }, a1: { type: "conditioning", label: "HIIT (light)", detail: "AMRAP 10:00 (easy): 200m jog · 8 air squats · 6 burpees. Gentle effort. Log rounds.", metric: "Rounds" } },
      { day: "Fri", a0: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null }, a1: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null } },
  ...
  {
    week: 6, phase: 2, focus: "Build begins. Easy Run Mon · Brick Tue · HIIT Wed · Rest Thu · Strength Fri · Long Run Sat.",
    days: [
      ...
      { day: "Tue", a0: { type: "brick", label: "BRICK — Ski + Run", detail: "Gym. 4×(ski erg 250m + 400m run at 8:30/mi). You lead the ski — this is your strength. Note ski splits.", metric: "Round times" }, a1: { type: "brick", label: "BRICK — Sled + Run", detail: "Home. 4×(sled push 12.5m + 400m treadmill at 9:00/mi). Your hardest station + running. Attack the sled.", metric: "Round times" } },
      { day: "Wed", a0: { type: "conditioning", label: "HIIT", detail: "AMRAP 18:00: 300m run · 15 walking lunges · 12 air squats · 10 burpees. Log rounds.", metric: "Rounds" }, a1: { type: "conditioning", label: "HIIT", detail: "AMRAP 18:00: 300m run · 15 walking lunges · 12 air squats · 10 burpees. Log rounds.", metric: "Rounds" } },
      { day: "Thu", a0: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null }, a1: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null } },
      { day: "Fri", a0: { type: "strength", label: "Strength A", detail: "Gym. Back squat 4×6 · RDL 3×8 · Walking lunges 3×20/leg · Kettlebell carry 3×100m · Calf raises 3×15.", metric: "Top weight" }, a1: { type: "strength", label: "Strength A", detail: "Home/gym. Back squat 4×6 · RDL 3×8 · Cable rows 3×12 · Box jumps 4×8 · Sandbag cleans 3×8 · Calf raises 3×15.", metric: "Top weight" } },
      { day: "Sat", a0: { type: "run_long", label: "Long Run 8km", detail: "Easy, 9:00–9:30/mi. Log pace.", metric: "Avg pace /mi or /km" }, a1: { type: "run_long", label: "Long Run 8km", detail: "9:30–10:00/mi. Log pace.", metric: "Avg pace /mi or /km" } },
      { day: "Sun", a0: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null }, a1: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null } },
    ],
  },
  {
    week: 7, phase: 2, focus: "Sled benchmark. Easy Run Mon · Sled/Brick Tue · Strength Wed · HIIT Thu · Rest Fri · Long Run Sat.",
    days: [
      { day: "Mon", a0: { type: "run_easy", label: "Easy Run 5km", detail: "Easy, 9:00–9:30/mi. Zone 2. Fresh start to the week.", metric: "Avg pace /mi or /km" }, a1: { type: "run_easy", label: "Easy Run 5km", detail: "Treadmill or outdoor, 9:30–10:00/mi. Zone 2. Relaxed effort.", metric: "Avg pace /mi or /km" } },
      { day: "Tue", a0: { type: "sled", label: "SLED @ Race Weight — Benchmark", detail: "Gym. Sled push 4×12.5m @ 152kg (or max) + pull 4×12.5m @ 103kg. Full rest. Benchmark day — log weight and time for every set.", metric: "Weight / time" }, a1: { type: "brick", label: "BRICK — Wall Ball + Run", detail: "Home. 4 Rounds: wall ball 20 reps (6kg) + box jumps 10 + 400m treadmill. Rest 90s. Note round times.", metric: "Round times" } },
      { day: "Wed", a0: { type: "strength", label: "Strength B", detail: "Gym. Deadlift 4×5 · Bent-over row 3×8 · Sandbag lunges 3×20m · Burpee broad jumps 3×8. Increase loads.", metric: "Top weight" }, a1: { type: "strength", label: "Strength B", detail: "Home/gym. Bench press 4×6 · Cable fly 3×10 · Sandbag lunges 4×20m · Wall ball 3×20 · Box jumps 3×10.", metric: "Top weight" } },
      { day: "Thu", a0: { type: "conditioning", label: "HIIT", detail: "5 Rounds For Time: 200m run · 10 burpees · 10 walking lunges · 8 jumping squats. Log time.", metric: "Total time" }, a1: { type: "conditioning", label: "HIIT", detail: "5 Rounds For Time: 200m run · 10 burpees · 10 walking lunges · 8 jumping squats. Log time.", metric: "Total time" } },
      { day: "Fri", a0: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null }, a1: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null } },
      { day: "Sat", a0: { type: "run_long", label: "Long Run 9km", detail: "Easy, 9:00–9:30/mi. Log pace.", metric: "Avg pace /mi or /km" }, a1: { type: "run_long", label: "Long Run 9km", detail: "9:30–10:00/mi. Log pace.", metric: "Avg pace /mi or /km" } },
      { day: "Sun", a0: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null }, a1: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null } },
    ],
  },
  {
    week: 8, phase: 2, focus: "Brick intensity up. HIIT Mon · Strength Tue · Rest Wed · Easy Run Thu · Brick Fri · Long Run Sat.",
    days: [
      { day: "Mon", a0: { type: "conditioning", label: "HIIT", detail: "AMRAP 20:00: 400m run · 15 walking lunges · 12 burpees · 10 jumping lunges. Log rounds.", metric: "Rounds" }, a1: { type: "conditioning", label: "HIIT", detail: "AMRAP 20:00: 400m run · 15 walking lunges · 12 burpees · 10 jumping lunges. Log rounds.", metric: "Rounds" } },
      ...
      { day: "Wed", a0: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null }, a1: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null } },
      { day: "Thu", a0: { type: "run_easy", label: "Easy Run 5km", detail: "Easy, 9:00–9:30/mi. Zone 2 — a needed breather between hard sessions.", metric: "Avg pace /mi or /km" }, a1: { type: "run_easy", label: "Easy Run 5km", detail: "Treadmill or outdoor, 9:30–10:00/mi. Zone 2.", metric: "Avg pace /mi or /km" } },
      { day: "Fri", a0: { type: "brick", label: "BRICK — Row + Run", detail: "Gym. 4×(row 250m + 800m run at 8:30/mi). Row is your strength — note splits.", metric: "Round times" }, a1: { type: "brick", label: "BRICK — Sled Pull + Run", detail: "Gym visit. 4×(sled pull 12.5m + 400m treadmill/run at 9:00/mi). Sled pull is a major weak spot — attack it today.", metric: "Round times" } },
      { day: "Sat", a0: { type: "run_long", label: "Long Run 10km", detail: "Easy, 9:00–9:30/mi. Log pace.", metric: "Avg pace /mi or /km" }, a1: { type: "run_long", label: "Long Run 10km", detail: "9:30–10:00/mi. Log pace.", metric: "Avg pace /mi or /km" } },
      { day: "Sun", a0: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null }, a1: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null } },
    ],
  },
  {
    ...
    days: [
      { day: "Mon", a0: { type: "run_easy", label: "Easy Run 3km (light)", detail: "Very easy, 10:00/mi or slower. Deload — just move.", metric: "Avg pace /mi or /km" }, a1: { type: "run_easy", label: "Easy Run 3km (light)", detail: "Very easy, 10:00+/mi. Deload — just move.", metric: "Avg pace /mi or /km" } },
      ...
      { day: "Wed", a0: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null }, a1: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null } },
      { day: "Thu", a0: { type: "conditioning", label: "HIIT (light)", detail: "AMRAP 12:00 (easy): 200m jog · 8 air squats · 6 burpees. Gentle effort. Log rounds.", metric: "Rounds" }, a1: { type: "conditioning", label: "HIIT (light)", detail: "AMRAP 12:00 (easy): 200m jog · 8 air squats · 6 burpees. Gentle effort. Log rounds.", metric: "Rounds" } },
      { day: "Fri", a0: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null }, a1: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null } },
      { day: "Sat", a0: { type: "stations", label: "Station Sharpener (light)", detail: "Gym. Easy skill work: ski 3×150m · row 3×150m · farmers carry 2×40m light. No racing the clock.", metric: "Time / splits" }, a1: { type: "stations", label: "Station Sharpener (light)", detail: "Home. Easy skill work: sled push 3×12.5m light · wall ball 3×10 (6kg) · sandbag lunges 2×10m.", metric: "Time / splits" } },
      { day: "Sun", a0: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null }, a1: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null } },
    ],
  },
  {
    week: 10, phase: 2, focus: "Peak build. Sled Mon · HIIT Tue · Easy Run Wed · Strength Thu · Rest Fri · Long Run Sat.",
    days: [
      { day: "Mon", a0: { type: "sled", label: "SLED @ Race Weight", detail: "Gym. Sled push 5×12.5m @ 152kg + pull 5×12.5m @ 103kg. Full rest. Beat your Week 7 benchmark times.", metric: "Weight / time" }, a1: { type: "brick", label: "BRICK — Full Station Combo", detail: "Home. 3 Rounds: sled push 12.5m + sled pull 12.5m + wall ball 15 reps + sandbag lunges 20m + 400m treadmill. Rest 3 min.", metric: "Round times" } },
      { day: "Tue", a0: { type: "conditioning", label: "HIIT", detail: "5 Rounds For Time: 400m run · 15 burpees · 15 air squats · 10 jumping lunges. Log time.", metric: "Total time" }, a1: { type: "conditioning", label: "HIIT", detail: "5 Rounds For Time: 400m run · 15 burpees · 15 air squats · 10 jumping lunges. Log time.", metric: "Total time" } },
      { day: "Wed", a0: { type: "run_easy", label: "Easy Run 6km", detail: "Easy, 9:00–9:30/mi. Zone 2. Longest mid-week run yet — fuelling matters.", metric: "Avg pace /mi or /km" }, a1: { type: "run_easy", label: "Easy Run 6km", detail: "Treadmill or outdoor, 9:30–10:00/mi. Steady Zone 2.", metric: "Avg pace /mi or /km" } },
      { day: "Thu", a0: { type: "strength", label: "Strength B", detail: "Gym. Deadlift 4×5 · Bent-over row 3×8 · Sandbag lunges 4×20m · Burpee broad jumps 4×10.", metric: "Top weight" }, a1: { type: "strength", label: "Strength B", detail: "Home/gym. Bench press 4×6 · Sandbag lunges 4×20m · Wall ball 4×20 · Box jumps 4×10.", metric: "Top weight" } },
      { day: "Fri", a0: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null }, a1: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null } },
      { day: "Sat", a0: { type: "run_long", label: "Long Run 12km", detail: "Easy, 9:00–9:30/mi. Log pace.", metric: "Avg pace /mi or /km" }, a1: { type: "run_long", label: "Long Run 12km", detail: "9:30–10:00/mi. Log pace.", metric: "Avg pace /mi or /km" } },
      { day: "Sun", a0: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null }, a1: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null } },
    ],
  },
  {
    week: 11, phase: 2, focus: "Race-intensity bricks. Easy Run Mon · Rest Tue · Strength Wed · HIIT Thu · Brick Fri · Long Run Sat.",
    days: [
      ...
      { day: "Tue", a0: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null }, a1: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null } },
      { day: "Wed", a0: { type: "strength", label: "Strength A (peak)", detail: "Gym. Back squat 4×6 · RDL 3×8 · Walking lunges 4×20/leg · Kettlebell carry 4×100m. Heaviest week yet.", metric: "Top weight" }, a1: { type: "strength", label: "Strength A (peak)", detail: "Home/gym. Back squat 4×8 · RDL 3×10 · Cable rows 4×12 · Sandbag cleans 3×10 · Box jumps 4×10.", metric: "Top weight" } },
      { day: "Thu", a0: { type: "conditioning", label: "HIIT", detail: "AMRAP 20:00: 400m run · 15 burpees · 20 walking lunges · 12 jumping squats. Log rounds.", metric: "Rounds" }, a1: { type: "conditioning", label: "HIIT", detail: "AMRAP 20:00: 400m run · 15 burpees · 20 walking lunges · 12 jumping squats. Log rounds.", metric: "Rounds" } },
      { day: "Fri", a0: { type: "brick", label: "BRICK — Ski + Farmers + Run", detail: "Gym. 4×(ski 250m + farmers carry 40m (2×24kg) + 800m at 8:30/mi). Your strength stations — own them. Log all splits.", metric: "Round times" }, a1: { type: "brick", label: "BRICK — Farmers + BBJ + Run", detail: "Gym visit. 4×(farmers carry 40m + 10 box jumps + 400m run at 8:30/mi). Attack your weak stations.", metric: "Round times" } },
      { day: "Sat", a0: { type: "run_long", label: "Long Run 14km", detail: "Easy, 9:00–9:30/mi. Log pace.", metric: "Avg pace /mi or /km" }, a1: { type: "run_long", label: "Long Run 14km", detail: "9:30–10:00/mi. Longest run before taper. Log pace.", metric: "Avg pace /mi or /km" } },
      { day: "Sun", a0: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null }, a1: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null } },
    ],
  },
  {
    week: 12, phase: 2, focus: "Peak week. Easy Run / Pace Test Mon · Stations Tue · Rest Wed · HIIT Thu · Strength Fri · Long Run Sat.",
    days: [
      { day: "Mon", a0: { type: "run_easy", label: "Easy Run 5km", detail: "Easy, 9:00–9:30/mi. Opener before a big week.", metric: "Avg pace /mi or /km" }, a1: { type: "run_pace", label: "Pace Test 8km", detail: "Push to 8:00–8:30/mi. Progress check from where you started — log every km split.", metric: "Avg pace /mi or /km" } },
      { day: "Tue", a0: { type: "stations", label: "Full Station Run-Through", detail: "Gym. Max effort continuous: ski 500m → row 500m → farmers carry 40m → sled push 12.5m → sled pull 12.5m. Timed. Race rehearsal for your stations.", metric: "Total time" }, a1: { type: "stations", label: "Full Station Run-Through", detail: "Home. Max effort continuous: sled push 12.5m → sled pull 12.5m → wall ball 30 reps → sandbag lunges 20m → box jumps 10. Timed.", metric: "Total time" } },
      { day: "Wed", a0: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null }, a1: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null } },
      { day: "Thu", a0: { type: "conditioning", label: "HIIT", detail: "AMRAP 20:00: 400m run · 20 burpees · 20 walking lunges · 15 air squats. Log rounds.", metric: "Rounds" }, a1: { type: "conditioning", label: "HIIT", detail: "AMRAP 20:00: 400m run · 20 burpees · 20 walking lunges · 15 air squats. Log rounds.", metric: "Rounds" } },
      { day: "Fri", a0: { type: "strength", label: "Strength B (peak)", detail: "Gym. Deadlift 4×5 · Bent-over row 4×8 · Sandbag lunges 4×20m · Burpee broad jumps 4×10. Heaviest of the plan.", metric: "Top weight" }, a1: { type: "strength", label: "Strength B (peak)", detail: "Home/gym. Bench press 4×6 · Sandbag lunges 4×20m · Wall ball 4×25 · Box jumps 4×12.", metric: "Top weight" } },
      { day: "Sat", a0: { type: "run_long", label: "Long Run 15km", detail: "Easy, 9:00/mi. Peak volume run. Log pace.", metric: "Avg pace /mi or /km" }, a1: { type: "run_long", label: "Long Run 15km", detail: "9:30–10:00/mi. Peak long run. Log pace.", metric: "Avg pace /mi or /km" } },
      { day: "Sun", a0: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null }, a1: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null } },
    ],
  },
  ...
  {
    week: 14, phase: 3, focus: "Sharpen. Easy Run Mon · Brick Tue · HIIT Wed · Rest Thu · Strength Fri · Long Run Sat.",
    days: [
      ...
      { day: "Tue", a0: { type: "brick", label: "BRICK — Weakness Fix", detail: "Gym. 3×(800m at 8:30/mi + your weakest station from the sim). Short and sharp.", metric: "Round times" }, a1: { type: "brick", label: "BRICK — Weakness Fix", detail: "Home. 3×(400m treadmill at 8:30/mi + your weakest station from the sim). Attack it — race is close.", metric: "Round times" } },
      { day: "Wed", a0: { type: "conditioning", label: "HIIT (short)", detail: "AMRAP 12:00: 200m run · 10 burpees · 10 air squats. Keep it short. Log rounds.", metric: "Rounds" }, a1: { type: "conditioning", label: "HIIT (short)", detail: "AMRAP 12:00: 200m run · 10 burpees · 10 air squats. Keep it short. Log rounds.", metric: "Rounds" } },
      { day: "Thu", a0: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null }, a1: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null } },
      { day: "Fri", a0: { type: "strength", label: "Strength (light)", detail: "Gym. 70% loads. Back squat 3×5 · RDL 3×6. Nothing heavy — protect the body.", metric: "Top weight" }, a1: { type: "strength", label: "Strength (light)", detail: "Home. 70% loads. Back squat 3×5 · Cable rows 3×8. Light and sharp.", metric: "Top weight" } },
      { day: "Sat", a0: { type: "run_long", label: "Long Run 10km", detail: "Easy, 9:00–9:30/mi. Last longer run before taper. Log pace.", metric: "Avg pace /mi or /km" }, a1: { type: "run_long", label: "Long Run 10km", detail: "9:30–10:00/mi. Last longer run before taper. Log pace.", metric: "Avg pace /mi or /km" } },
      { day: "Sun", a0: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null }, a1: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null } },
    ],
  },
  {
