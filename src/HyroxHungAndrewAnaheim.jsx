...
const weekPlan = [
  ...
  {
    week: 2, phase: 1, focus: "Volume up. Rest Mon · Easy Run Tue · Stations Wed · Strength Thu · HIIT Fri · Long Run Sat.",
    days: [
      ...
      { day: "Tue", a0: { type: "run_easy", label: "Easy Run 4km", detail: "Easy, 9:00–9:30/mi. Zone 2. Building from last week.", metric: "Avg pace /mi or /km" }, a1: { type: "run_easy", label: "Easy Run 4km", detail: "Treadmill or outdoor, 9:30–10:00/mi. Steady Zone 2.", metric: "Avg pace /mi or /km" } },
      { day: "Wed", a0: { type: "stations", label: "Machines — Volume", detail: "Gym. Ski erg 4×250m (note splits) · Row 4×250m · Farmers carry 4×40m. Rest 90s between sets.", metric: "Time / splits" }, a1: { type: "stations", label: "Ground Work — Volume", detail: "Home. Sled push 4×12.5m · Wall ball 4×15 (6kg) · Sandbag lunges 4×20m.", metric: "Time / splits" } },
      { day: "Thu", a0: { type: "strength", label: "Strength A", detail: "Gym. Back squat 4×6 · RDL 3×8 · Walking lunges 3×20/leg · Kettlebell carry 3×100m · Calf raises 3×15.", metric: "Top weight" }, a1: { type: "strength", label: "Strength A", detail: "Home gym. Back squat 4×6 · RDL 3×8 · Cable rows 3×10 · Box jumps 3×8 · Calf raises 3×15. Add 5lb from last week.", metric: "Top weight" } },
  ...
  {
    week: 7, phase: 2, focus: "Sled benchmark. Rest Mon · Easy Run Tue · Sled/Brick Wed · Strength Thu · HIIT Fri · Long Run Sat.",
    days: [
      { day: "Mon", a0: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null }, a1: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null } },
      { day: "Tue", a0: { type: "run_easy", label: "Easy Run 5km", detail: "Easy, 9:00–9:30/mi. Zone 2. Fresh start to the week.", metric: "Avg pace /mi or /km" }, a1: { type: "run_easy", label: "Easy Run 5km", detail: "Treadmill or outdoor, 9:30–10:00/mi. Zone 2. Relaxed effort.", metric: "Avg pace /mi or /km" } },
      ...
      { day: "Thu", a0: { type: "strength", label: "Strength B", detail: "Gym. Deadlift 4×5 · Bent-over row 3×8 · Sandbag lunges 3×20m · Burpee broad jumps 3×8. Increase loads.", metric: "Top weight" }, a1: { type: "strength", label: "Strength B", detail: "Home/gym. Bench press 4×6 · Cable fly 3×10 · Sandbag lunges 4×20m · Wall ball 3×20 · Box jumps 3×10.", metric: "Top weight" } },
      { day: "Fri", a0: { type: "conditioning", label: "HIIT", detail: "5 Rounds For Time: 200m run · 10 burpees · 10 walking lunges · 8 jumping squats. Log time.", metric: "Total time" }, a1: { type: "conditioning", label: "HIIT", detail: "5 Rounds For Time: 200m run · 10 burpees · 10 walking lunges · 8 jumping squats. Log time.", metric: "Total time" } },
  ...
  {
    week: 12, phase: 2, focus: "Peak week. Rest Mon · Easy Run / Pace Test Tue · Stations Wed · HIIT Thu · Strength Fri · Long Run Sat.",
    days: [
      { day: "Mon", a0: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null }, a1: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null } },
      { day: "Tue", a0: { type: "run_easy", label: "Easy Run 5km", detail: "Easy, 9:00–9:30/mi. Opener before a big week.", metric: "Avg pace /mi or /km" }, a1: { type: "run_pace", label: "Pace Test 8km", detail: "Push to 8:00–8:30/mi. Progress check from where you started — log every km split.", metric: "Avg pace /mi or /km" } },
