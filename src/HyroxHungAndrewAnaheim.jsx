...
const weekPlan = [
  ...
  {
    week: 1, phase: 1, focus: "Ease in. Hung runs Mon/Fri/Sat. Andrew runs Mon/Fri/Sat. Station intro. First HIIT.",
    days: [
      { day: "Mon", a0: { type: "run_easy", label: "Easy Run 3mi", detail: "Easy, 9:00–9:30/mi. Zone 2, conversational. This is your baseline — note how your legs feel.", metric: "Avg pace /mi or /km" }, a1: { type: "run_easy", label: "Easy Treadmill Run 3mi", detail: "Treadmill or outdoor at 9:30–10:00/mi, Zone 2. Conversational — no pushing yet. Log your pace.", metric: "Avg pace /mi or /km" } },
      ...
      { day: "Fri", a0: { type: "run_easy", label: "Easy Run 3mi", detail: "Second run this week. Easy, 9:00–9:30/mi. Zone 2, keep it comfortable.", metric: "Avg pace /mi or /km" }, a1: { type: "run_easy", label: "Easy Run 3mi", detail: "Second run this week. Treadmill or outdoor, 9:30–10:00/mi. Easy and relaxed.", metric: "Avg pace /mi or /km" } },
      { day: "Sat", a0: { type: "run_easy", label: "Long Run 3km — Compete", detail: "Easy effort, 9:00–9:30/mi. Log your pace — compare with Andrew.", metric: "Avg pace /mi or /km" }, a1: { type: "run_easy", label: "Long Run 3km — Compete", detail: "Treadmill or outdoor, 9:30–10:00/mi. Log your pace — compare with Hung.", metric: "Avg pace /mi or /km" } },
  ...
  {
    week: 2, phase: 1, focus: "Volume up. Hung runs Mon/Fri/Sat. Andrew runs Mon/Fri/Sat.",
    days: [
      { day: "Mon", a0: { type: "run_easy", label: "Easy Run 4mi", detail: "Easy, 9:00–9:30/mi. Zone 2. Building from last week.", metric: "Avg pace /mi or /km" }, a1: { type: "run_easy", label: "Easy Run 3.5mi", detail: "Treadmill or outdoor at 9:30–10:00/mi. Steady Zone 2. Focus on time on feet.", metric: "Avg pace /mi or /km" } },
      ...
      { day: "Fri", a0: { type: "run_easy", label: "Easy Run 3mi", detail: "Second run this week. Easy, 9:00–9:30/mi. Keep it comfortable before Saturday.", metric: "Avg pace /mi or /km" }, a1: { type: "run_easy", label: "Easy Run 3mi", detail: "Second run this week. Treadmill or outdoor, 9:30–10:00/mi. Easy before the long run.", metric: "Avg pace /mi or /km" } },
      { day: "Sat", a0: { type: "run_easy", label: "Long Run 4km — Compete", detail: "Easy, 9:00–9:30/mi. Log pace — compare with Andrew.", metric: "Avg pace /mi or /km" }, a1: { type: "run_easy", label: "Long Run 4km — Compete", detail: "Treadmill or outdoor, 9:30–10:00/mi. Log pace — compare with Hung.", metric: "Avg pace /mi or /km" } },
      { day: "Sun", a0: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null }, a1: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null } },
    ],
  },
  {
    week: 3, phase: 1, focus: "Strength B intro. Hung runs Mon/Fri/Sat. Andrew runs Mon/Wed/Sat.",
    days: [
      { day: "Mon", a0: { type: "run_easy", label: "Easy Run 4mi", detail: "Easy, 9:00–9:30/mi. Zone 2, keep it comfortable.", metric: "Avg pace /mi or /km" }, a1: { type: "run_easy", label: "Easy Run 4mi", detail: "Treadmill or outdoor at 9:30–10:00/mi. Zone 2, keep it comfortable.", metric: "Avg pace /mi or /km" } },
      ...
      { day: "Wed", a0: { type: "stations", label: "Sled + Machine Circuit", detail: "Gym. 3 Rounds: sled push 12.5m heavy + ski 250m + row 250m + farmers carry 40m. Rest 2 min. Sled is your weak spot — attack it.", metric: "Round times" }, a1: { type: "run_easy", label: "Easy Run 3mi", detail: "Mid-week run. Treadmill or outdoor, 9:30–10:00/mi. Different day from Hung this week.", metric: "Avg pace /mi or /km" } },
      ...
      { day: "Fri", a0: { type: "run_easy", label: "Easy Run 3mi", detail: "Second run this week. Easy, 9:00–9:30/mi.", metric: "Avg pace /mi or /km" }, a1: { type: "sled", label: "Sled Focus", detail: "Home. 4×(sled push 12.5m + sled pull 12.5m). Full rest between. Your #1 weak station — benchmark weight and time. Log both.", metric: "Weight / time" } },
      { day: "Sat", a0: { type: "run_easy", label: "Long Run 5km — Compete", detail: "Easy, 9:00–9:30/mi. Log pace — compare with Andrew.", metric: "Avg pace /mi or /km" }, a1: { type: "run_easy", label: "Long Run 5km — Compete", detail: "Treadmill or outdoor, 9:30–10:00/mi. Log pace — compare with Hung.", metric: "Avg pace /mi or /km" } },
      { day: "Sun", a0: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null }, a1: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null } },
    ],
  },
  {
    week: 4, phase: 1, focus: "Full circuits. Hung runs Tue/Fri/Sat. Andrew runs Mon/Fri/Sat.",
    days: [
      { day: "Mon", a0: { type: "strength", label: "Strength A", detail: "Gym. Back squat 4×6 · RDL 3×8 · Walking lunges 3×20/leg · Kettlebell carry 3×100m · Calf raises 3×15. Beat last week's weights.", metric: "Top weight" }, a1: { type: "run_easy", label: "Easy Run 4mi", detail: "Treadmill or outdoor at 9:30–10:00/mi. Steady Zone 2.", metric: "Avg pace /mi or /km" } },
      { day: "Tue", a0: { type: "run_easy", label: "Easy Run 4mi", detail: "Mid-week run. Easy, 9:00–9:30/mi. Different day from last week.", metric: "Avg pace /mi or /km" }, a1: { type: "strength", label: "Strength A", detail: "Home gym. Back squat 4×6 · RDL 3×8 · Cable rows 3×12 · Box jumps 4×8 · Calf raises 3×15. Beat last week.", metric: "Top weight" } },
      ...
      { day: "Fri", a0: { type: "run_easy", label: "Easy Run 3mi", detail: "Second run this week. Easy, 9:00–9:30/mi. Light before the pace run Saturday.", metric: "Avg pace /mi or /km" }, a1: { type: "run_easy", label: "Easy Run 3mi", detail: "Second run this week. Treadmill or outdoor, 9:30–10:00/mi. Easy before Saturday.", metric: "Avg pace /mi or /km" } },
      { day: "Sat", a0: { type: "run_pace", label: "Pace Run 5km — Compete", detail: "Push to 8:30–9:00/mi. Not a sprint, but not easy. Log pace — compare with Andrew.", metric: "Avg pace /mi or /km" }, a1: { type: "run_pace", label: "Pace Run 5km — Compete", detail: "Push to 9:00–9:30/mi. Step it up from your easy pace. Log pace — compare with Hung.", metric: "Avg pace /mi or /km" } },
      { day: "Sun", a0: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null }, a1: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null } },
    ],
  },
  {
    week: 5, phase: 1, focus: "Deload. 2 light runs each. Station sharpener replaces long run.",
    days: [
      { day: "Mon", a0: { type: "run_easy", label: "Easy Run 3mi (light)", detail: "Very easy, 10:00/mi or slower. Deload — just move, no effort.", metric: "Avg pace /mi or /km" }, a1: { type: "run_easy", label: "Easy Run 3mi (light)", detail: "Very easy, 10:00–10:30/mi. Deload — no pushing, just moving.", metric: "Avg pace /mi or /km" } },
      ...
      { day: "Wed", a0: { type: "run_easy", label: "Easy Run 3mi (light)", detail: "Second light run. Very easy, 10:00/mi. Deload — keep it very comfortable.", metric: "Avg pace /mi or /km" }, a1: { type: "run_easy", label: "Easy Run 3mi (light)", detail: "Second light run. Very easy, 10:00/mi. Deload — keep it gentle.", metric: "Avg pace /mi or /km" } },
  ...
  {
    week: 6, phase: 2, focus: "Build begins. Hung runs Mon/Fri/Sat. Andrew runs Mon/Fri/Sat. Bricks on Wed.",
    days: [
      { day: "Mon", a0: { type: "run_easy", label: "Easy Run 5mi", detail: "Easy, 9:00–9:30/mi. Zone 2 opener for build phase.", metric: "Avg pace /mi or /km" }, a1: { type: "run_easy", label: "Easy Run 5mi", detail: "Treadmill or outdoor at 9:30–10:00/mi. Zone 2. First run over 5 miles — keep it comfortable.", metric: "Avg pace /mi or /km" } },
      ...
      { day: "Fri", a0: { type: "run_easy", label: "Easy Run 4mi", detail: "Second run this week. Easy, 9:00–9:30/mi. Before Saturday long run.", metric: "Avg pace /mi or /km" }, a1: { type: "run_easy", label: "Easy Run 4mi", detail: "Second run this week. Treadmill or outdoor, 9:30–10:00/mi. Easy before Saturday.", metric: "Avg pace /mi or /km" } },
      { day: "Sat", a0: { type: "run_long", label: "Long Run 6km — Compete", detail: "Easy, 9:00–9:30/mi. Log pace — compare with Andrew.", metric: "Avg pace /mi or /km" }, a1: { type: "run_long", label: "Long Run 6km — Compete", detail: "9:30–10:00/mi. Building your base. Log pace — compare with Hung.", metric: "Avg pace /mi or /km" } },
      { day: "Sun", a0: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null }, a1: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null } },
    ],
  },
  {
    week: 7, phase: 2, focus: "Sled benchmark. Hung runs Tue/Fri/Sat. Andrew runs Mon/Fri/Sat.",
    days: [
      { day: "Mon", a0: { type: "strength", label: "Strength B", detail: "Gym. Deadlift 4×5 · Bent-over row 3×8 · Sandbag lunges 3×20m · Burpee broad jumps 3×8. Increase loads.", metric: "Top weight" }, a1: { type: "run_pace", label: "Pace Run 4mi", detail: "Push to 8:45–9:00/mi for 4 miles. First real pace effort. Treadmill for control.", metric: "Avg pace /mi or /km" } },
      { day: "Tue", a0: { type: "run_easy", label: "Easy Run 5mi", detail: "Easy, 9:00–9:30/mi. Zone 2 before the hard mid-week sled work.", metric: "Avg pace /mi or /km" }, a1: { type: "strength", label: "Strength B", detail: "Home/gym. Bench press 4×6 · Cable fly 3×10 · Sandbag lunges 4×20m · Wall ball 3×20 · Box jumps 3×10.", metric: "Top weight" } },
      { day: "Wed", a0: { type: "sled", label: "SLED @ Race Weight — Benchmark", detail: "Gym. Sled push 4×12.5m @ 152kg (or max) + pull 4×12.5m @ 103kg. Full rest. Weak spot — benchmark day. Log weight and time.", metric: "Weight / time" }, a1: { type: "stations", label: "Wall Ball + BBJ Circuit", detail: "Home. 4 Rounds: wall ball 20 reps (6kg) + 10 box jumps (BBJ sub) + sandbag lunges 20m. Rest 90s. Note round times.", metric: "Round times" } },
      ...
      { day: "Fri", a0: { type: "run_easy", label: "Easy Run 4mi", detail: "Second run this week. Easy, 9:00–9:30/mi.", metric: "Avg pace /mi or /km" }, a1: { type: "run_easy", label: "Easy Run 4mi", detail: "Second run this week. Treadmill or outdoor, 9:30–10:00/mi.", metric: "Avg pace /mi or /km" } },
      { day: "Sat", a0: { type: "run_long", label: "Long Run 7km — Compete", detail: "Easy, 9:00–9:30/mi. Log pace — compare with Andrew.", metric: "Avg pace /mi or /km" }, a1: { type: "run_long", label: "Long Run 7km — Compete", detail: "9:30–10:00/mi. Log pace — compare with Hung.", metric: "Avg pace /mi or /km" } },
      { day: "Sun", a0: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null }, a1: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null } },
    ],
  },
  {
    week: 8, phase: 2, focus: "Brick intensity up. Hung runs Mon/Fri/Sat. Andrew runs Mon/Fri/Sat.",
    days: [
      { day: "Mon", a0: { type: "run_easy", label: "Easy Run 5mi", detail: "Easy, 9:00–9:30/mi. Zone 2 opener for a hard week.", metric: "Avg pace /mi or /km" }, a1: { type: "run_pace", label: "Pace Run 4mi", detail: "Target 8:30–9:00/mi. Building pace each week. Treadmill for consistency.", metric: "Avg pace /mi or /km" } },
      ...
      { day: "Fri", a0: { type: "run_easy", label: "Easy Run 4mi", detail: "Second run this week. Easy, 9:00–9:30/mi. Relaxed before Saturday.", metric: "Avg pace /mi or /km" }, a1: { type: "run_easy", label: "Easy Run 4mi", detail: "Second run this week. Treadmill or outdoor, 9:30–10:00/mi. Easy before the long run.", metric: "Avg pace /mi or /km" } },
      { day: "Sat", a0: { type: "run_long", label: "Long Run 8km — Compete", detail: "Easy, 9:00–9:30/mi. Log pace — compare with Andrew.", metric: "Avg pace /mi or /km" }, a1: { type: "run_long", label: "Long Run 8km — Compete", detail: "9:30–10:00/mi. Log pace — compare with Hung.", metric: "Avg pace /mi or /km" } },
      { day: "Sun", a0: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null }, a1: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null } },
    ],
  },
  {
    week: 9, phase: 2, focus: "Mid-build deload. 2 light runs each. Station sharpener replaces long run.",
    days: [
      { day: "Mon", a0: { type: "run_easy", label: "Easy Run 3mi (light)", detail: "Very easy, 10:00/mi or slower. Deload — just move, no effort.", metric: "Avg pace /mi or /km" }, a1: { type: "run_easy", label: "Easy Run 3mi (light)", detail: "Very easy, 10:00+/mi. Deload — just move.", metric: "Avg pace /mi or /km" } },
      ...
      { day: "Wed", a0: { type: "run_easy", label: "Easy Run 3mi (light)", detail: "Second light run. Very easy, 10:00/mi. Deload — keep it gentle.", metric: "Avg pace /mi or /km" }, a1: { type: "run_easy", label: "Easy Run 3mi (light)", detail: "Second light run. Very easy, 10:00/mi. Deload.", metric: "Avg pace /mi or /km" } },
  ...
  {
    week: 10, phase: 2, focus: "Peak build. Hung runs Tue/Fri/Sat. Andrew runs Mon/Fri/Sat.",
    days: [
      { day: "Mon", a0: { type: "strength", label: "Strength B", detail: "Gym. Deadlift 4×5 · Bent-over row 3×8 · Sandbag lunges 4×20m · Burpee broad jumps 4×10.", metric: "Top weight" }, a1: { type: "run_pace", label: "Pace Run 5mi", detail: "Target 8:15–8:30/mi. Pushing toward goal pace. Keep form relaxed.", metric: "Avg pace /mi or /km" } },
      { day: "Tue", a0: { type: "run_easy", label: "Easy Run 5mi", detail: "Easy, 9:00–9:30/mi. Zone 2. Longest mid-week run yet — fuelling matters.", metric: "Avg pace /mi or /km" }, a1: { type: "strength", label: "Strength B", detail: "Home/gym. Bench press 4×6 · Sandbag lunges 4×20m · Wall ball 4×20 · Box jumps 4×10.", metric: "Top weight" } },
      ...
      { day: "Fri", a0: { type: "run_easy", label: "Easy Run 5mi", detail: "Second run this week. Easy, 9:00–9:30/mi. Steady before Saturday.", metric: "Avg pace /mi or /km" }, a1: { type: "run_easy", label: "Easy Run 5mi", detail: "Second run this week. Treadmill or outdoor, 9:30–10:00/mi.", metric: "Avg pace /mi or /km" } },
      { day: "Sat", a0: { type: "run_long", label: "Long Run 10km — Compete", detail: "Easy, 9:00–9:30/mi. Log pace — compare with Andrew.", metric: "Avg pace /mi or /km" }, a1: { type: "run_long", label: "Long Run 10km — Compete", detail: "9:30–10:00/mi. 6+ miles — building to race distance. Log pace — compare with Hung.", metric: "Avg pace /mi or /km" } },
      { day: "Sun", a0: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null }, a1: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null } },
    ],
  },
  {
    week: 11, phase: 2, focus: "Race-intensity bricks. Hung runs Mon/Fri/Sat. Andrew runs Mon/Fri/Sat.",
    days: [
      { day: "Mon", a0: { type: "run_easy", label: "Easy Run 6mi", detail: "Easy, 9:00–9:30/mi. Zone 2 opener for the hardest build week.", metric: "Avg pace /mi or /km" }, a1: { type: "run_pace", label: "Pace Run 5mi", detail: "Target 8:00–8:30/mi. Closing in on goal pace. Track every mile split.", metric: "Avg pace /mi or /km" } },
      ...
      { day: "Fri", a0: { type: "run_easy", label: "Easy Run 5mi", detail: "Second run this week. Easy, 9:00–9:30/mi.", metric: "Avg pace /mi or /km" }, a1: { type: "run_easy", label: "Easy Run 5mi", detail: "Second run this week. Treadmill or outdoor, 9:30–10:00/mi.", metric: "Avg pace /mi or /km" } },
      { day: "Sat", a0: { type: "run_long", label: "Long Run 11km — Compete", detail: "Easy, 9:00–9:30/mi. Log pace — compare with Andrew.", metric: "Avg pace /mi or /km" }, a1: { type: "run_long", label: "Long Run 11km — Compete", detail: "9:30–10:00/mi. Longest run before taper. Log pace — compare with Hung.", metric: "Avg pace /mi or /km" } },
      { day: "Sun", a0: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null }, a1: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null } },
    ],
  },
  {
    week: 12, phase: 2, focus: "Peak week. Hung runs Mon/Fri/Sat. Andrew runs Mon/Fri/Sat. Andrew: 6mi pace test.",
    days: [
      { day: "Mon", a0: { type: "run_easy", label: "Easy Run 5mi", detail: "Easy, 9:00–9:30/mi. Opener before peak week.", metric: "Avg pace /mi or /km" }, a1: { type: "run_pace", label: "Pace Run 6mi — TEST", detail: "Target 8:00–8:30/mi for 6 miles. Progress check vs. Week 1 baseline. Log every mile split.", metric: "Avg pace /mi or /km" } },
      ...
      { day: "Fri", a0: { type: "run_easy", label: "Easy Run 4mi", detail: "Second run this week. Easy, 9:00–9:30/mi. Light before the peak long run.", metric: "Avg pace /mi or /km" }, a1: { type: "run_easy", label: "Easy Run 4mi", detail: "Second run this week. Treadmill or outdoor, 9:30–10:00/mi. Light before Saturday.", metric: "Avg pace /mi or /km" } },
      { day: "Sat", a0: { type: "run_long", label: "Long Run 12km — Compete", detail: "Easy, 9:00/mi. Peak volume run. Log pace — compare with Andrew.", metric: "Avg pace /mi or /km" }, a1: { type: "run_long", label: "Long Run 12km — Compete", detail: "9:30–10:00/mi. Peak long run. Log pace — compare with Hung.", metric: "Avg pace /mi or /km" } },
      { day: "Sun", a0: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null }, a1: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null } },
    ],
  },
  // ─── PHASE 3: PEAK + TAPER (Weeks 13–16) ──────────────────────────────────
  {
    ...
    days: [
      { day: "Mon", a0: { type: "strength", label: "Strength (moderate)", detail: "Gym. 80% loads. Back squat 3×5 · RDL 3×6 · Walking lunges 2×16/leg. Touch every movement.", metric: "Top weight" }, a1: { type: "run_easy", label: "Easy Run 4mi", detail: "Easy, 9:30/mi. Active recovery before race sim week.", metric: "Avg pace /mi or /km" } },
      { day: "Tue", a0: { type: "run_easy", label: "Easy Run 5km", detail: "Easy, 9:00–9:30/mi. Shake out the legs before the sim.", metric: "Avg pace /mi or /km" }, a1: { type: "strength", label: "Strength (moderate)", detail: "Home/gym. 80% loads. Back squat 3×5 · Cable rows 3×8 · Wall ball 3×15. Nothing heavy.", metric: "Top weight" } },
  ...
  {
    week: 14, phase: 3, focus: "Sharpen. Fix sim gaps. Hung runs Mon/Fri/Sat. Andrew runs Mon/Fri/Sat.",
    days: [
      { day: "Mon", a0: { type: "run_easy", label: "Easy Run 4mi", detail: "Easy, 9:00–9:30/mi. Opener after race sim week.", metric: "Avg pace /mi or /km" }, a1: { type: "run_pace", label: "Pace Run 4mi", detail: "Target 8:00/mi. Sharpening pace. Log every mile.", metric: "Avg pace /mi or /km" } },
      ...
      { day: "Fri", a0: { type: "run_easy", label: "Easy Run 3mi", detail: "Second run this week. Easy, 9:00–9:30/mi. Light before the last long run.", metric: "Avg pace /mi or /km" }, a1: { type: "run_easy", label: "Easy Run 3mi", detail: "Second run this week. Treadmill or outdoor, 9:30–10:00/mi. Easy before Saturday.", metric: "Avg pace /mi or /km" } },
      { day: "Sat", a0: { type: "run_long", label: "Long Run 8km — Compete", detail: "Easy, 9:00–9:30/mi. Last longer run before taper. Log pace — compare with Andrew.", metric: "Avg pace /mi or /km" }, a1: { type: "run_long", label: "Long Run 8km — Compete", detail: "9:30–10:00/mi. Last longer run before taper. Log pace — compare with Hung.", metric: "Avg pace /mi or /km" } },
      { day: "Sun", a0: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null }, a1: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null } },
    ],
  },
  {
    week: 15, phase: 3, focus: "Taper. Hung runs Mon/Thu/Sat. Andrew runs Mon/Thu/Sat. Protect the legs.",
    days: [
      { day: "Mon", a0: { type: "run_easy", label: "Easy Run 3mi", detail: "Easy, 9:30/mi. Taper — just stay loose.", metric: "Avg pace /mi or /km" }, a1: { type: "run_easy", label: "Easy Run 3mi", detail: "Very easy, 10:00/mi. Taper — just stay loose.", metric: "Avg pace /mi or /km" } },
      ...
      { day: "Sat", a0: { type: "run_easy", label: "Shakeout 3km — Compete", detail: "Very easy, 9:30/mi. Last training run. Log pace — compare with Andrew.", metric: "Avg pace /mi or /km" }, a1: { type: "run_easy", label: "Shakeout 3km — Compete", detail: "Very easy, 10:00/mi. Last training run. Log pace — compare with Hung.", metric: "Avg pace /mi or /km" } },
      { day: "Sun", a0: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null }, a1: { type: "rest", label: "Rest / Mobility", detail: "Recovery.", metric: null } },
    ],
  },
  {
